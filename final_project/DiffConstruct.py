...
def construct_HR_Ann(gamma, Nmax): #Adapted by Tristin Might be wrong
    '''
    PARAMETERS
    ----------
    gamma: Aspect ratio
...
def construct_HR_Bnn(gamma, Mmax): #Adapted by Tristin Also might be wrong
    '''
    PARAMETERS
    ----------
    gamma: Aspect ratio
...
def construct_HR_Znn(gamma, Nmax):
    '''
    PARAMETERS
    ----------
    gamma: Aspect ratio
    ...
    '''
    return np.linalg.eig(construct_HR_Ann(gamma, Nmax))[0], np.linalg.eig(construct_HR_Ann(gamma, Nmax))[1]


# Constructs E_nn for HRN
def construct_HR_Enn(gamma, Nmax):
    '''
    PARAMETERS
    ----------
    gamma: Aspect ratio
    ...
    '''
    return construct_HR_Znn(gamma, Nmax)[1].dot(construct_HR_Ann(gamma, Nmax).dot(np.linalg.inv(construct_HR_Znn(gamma, Nmax)[1])))

# Constructs F_nm for HRN
def construct_HR_Fnm(eta,dr,gamma, Nmax, Mmax): #Writen By Tristin --Very possibly wrong
    '''
    PARAMETERS
    ----------
    eta:
